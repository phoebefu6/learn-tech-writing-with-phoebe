...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    var isDeepDive = /Deep dive \d/.test(crumb.textContent);
    if (m || isDeepDive) {
      var current = m ? parseInt(m[1], 10) : 0;
      var pages = ["01-why-docs-fail.html", "02-sentences-that-work.html", "03-structure-readers-scan.html",
                   "04-the-readme.html", "05-diataxis.html", "06-reference-adrs-changelogs.html",
                   "07-docs-as-code.html", "08-edit-and-ship.html"];
      ...
      dd.href = "91-error-messages.html";
      dd.className = "dd-chip" + (isDeepDive ? " here" : "");
      dd.textContent = "+4 deep dives";
